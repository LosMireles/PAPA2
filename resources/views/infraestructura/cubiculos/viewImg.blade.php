    ...
    <a href="/cubiculos" class="btn btn-primary">
		...
		<div class="row text-center">
			<div class="col-md-6 col-md-offset-3">
				<form class="form-horizontal" action = "{{action('CubiculoController@guardarImg',['tipo'=>$tipo])}}" method="POST" enctype="multipart/form-data">
				...
				<figure>
					<div class='buttonimg'>
						<div class="img_div">
							...
							<div class="row text-center">
								<form action="{{ route('borrarImgCubiculo', ['tipo'=> $tipo, 'imagen' => pathinfo($image)['basename']]) }}" method="post">
                  {{ csrf_field() }}
