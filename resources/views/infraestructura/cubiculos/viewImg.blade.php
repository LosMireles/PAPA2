...
@section('descripcion')
    <a href="/inciso_9_2_11" class="btn btn-primary">
        Regresar
    </a>

		<div class="row text-center">
			<div class="col-md-6 col-md-offset-3">
				<form class="form-horizontal" action = "{{action('CubiculoController@guardarImg',['nombre'=>$nombre])}}" method="POST" enctype="multipart/form-data">
...
@section('Fotografias')
  ...
  <?php
    $dirname = 'storage/infraestructura/cubiculos/' . $nombre . '/';
