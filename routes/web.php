...
Route::get('/aulas/relacionar_equipos/{id}/{inciso?}', 'AulaController@relacionar_equipos');
Route::post('/aulas/relacionar_equipos/{id}/{inciso?}', 'AulaController@relacionar_equipos_post');
